...
const DriverWrapper = ({ lang, setLang }) => {
  ...
  // Allow sidebar to open language modal via global event
  useEffect(() => {
  ...
  useEffect(() => {
    const hasSelectedLang = localStorage.getItem('driver_lang_modal_shown');
    if (!hasSelectedLang) {
      setShowLangModal(true);
      localStorage.setItem('driver_lang_modal_shown', 'true');
    }
  }, []);
